...
%   Produces a question slide using *abbrev*-*answer*-q.png as image
%   and the five answers as text. One of the five must match *answer*.
%
% \witqend
%   Produces answers slides, now with *abbrev*-*answer*.png as
...
\def\witq#1#2#3#4#5#6{
    ...
    \begin{column}{0.7\textwidth}
        \vspace{-1cm}
        \begin{center}
        \noindent\includegraphics[width=\textwidth]{img/\@witqprefix-#1-q.png}
        \end{center}
    \end{column}
...
\def\@witq#1#2#3{
    ...
    \g@addto@macro\answerimages{\only<#3>{\noindent\includegraphics[width=\textwidth]{img/\@witqprefix-#1.png}}}
}
